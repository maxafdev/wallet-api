...
public class ExceptionHelper extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {WrongStatementTypeException.class})
    public ResponseEntity<Object> handleWrongStatementTypeException(WrongStatementTypeException statementTypeException){
        return new ResponseEntity<>(statementTypeException.getMessage() , HttpStatus.BAD_REQUEST);
    }
